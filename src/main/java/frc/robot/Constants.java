...
public final class Constants {
  public static final class DriveConstants {
    public static final int kLeftFrontMotor1Port = 10;
    public static final int kLeftBackMotor1Port = 40;
    public static final int kRightFrontMotor1Port = 20;
    public static final int kRightBackMotor1Port = 30;
  ...
  public static final class ElevatorConstants{
    public static final double circumference = .18;
  }
}
