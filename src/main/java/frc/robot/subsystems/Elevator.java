...
public class Elevator extends SubsystemBase {
    ...
    private final SparkMax m_LeftFrontMotor = new SparkMax(52, MotorType.kBrushless);
    ...
    public Elevator() {
        ...
        frontLeftSparkMaxConfig.encoder
                .positionConversionFactor(ElevatorConstants.circumference)
                .velocityConversionFactor(ElevatorConstants.circumference / 60);
